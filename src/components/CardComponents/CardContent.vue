	...
	<section class="card">
		...
		<div class="card-content">
			...
			<div class="card-information">
				<div class="card-information_item">
					<div class="card-information_item__images">
						<img src="@/assets/images/icons/secure.svg" alt="">
					</div>
					<p class='card-information_item__text'>Secure payment</p>
				</div>
				<div class="card-information_item">
					<div class="card-information_item__images">
						<img src="@/assets/images/icons/size.svg" alt="">
					</div>
					<p class='card-information_item__text'>Size & Fit</p>
				</div>
				<div class="card-information_item">
					<div class="card-information_item__images">
						<img src="@/assets/images/icons/shipping.svg" alt="">
					</div>
					<p class='card-information_item__text'>Free shipping</p>
				</div>
				<div class="card-information_item">
					<div class="card-information_item__images">
						<img src="@/assets/images/icons/returns.svg" alt="">
					</div>
					<p class='card-information_item__text'>Free Shipping & Returns</p>
				</div>
			</div>
		</div>
	</section>
